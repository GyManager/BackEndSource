...
@Slf4j
public class GyManagerAuthorizationFilter extends OncePerRequestFilter {
    ...
    public GyManagerAuthorizationFilter(String loginPath, String refreshPath, TokenService tokenService) {
        ...
        if (request.getServletPath().equals(loginPath) || request.getServletPath().equals(refreshPath)) {
            ...
            if(Objects.nonNull(authorizationHeader) && authorizationHeader.startsWith(BEARER)){
                try {
                    ...
                    final UsuarioToken usuarioToken = tokenService.decodeJwtToken(token);

                    UsernamePasswordAuthenticationToken authenticationToken =
                            new UsernamePasswordAuthenticationToken(usuarioToken.getUsername(),
                                    null,
